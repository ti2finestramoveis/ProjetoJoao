                  ...
                  @csrf
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="nome" value="{{ $produto ->Nome }}" class="form-control" id="inputEmail4" placeholder="Nome do Produto">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="inputPassword4">Quantidade</label>
                            <input type="number" name="estoque" value="{{ $produto ->Estoque }}" class="form-control" id="inputPassword4" placeholder="Quantidade">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="inputAddress">Valor do Produto</label>
                            <input type="text" name="valor" value="{{ $produto ->valor }}" class="form-control" id="inputAddress" placeholder="Valor do Produto">
                        </div>
                        <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="descricao" value="{{ $produto ->descricao }}" class="form-control" id="inputAddress" placeholder="Descrição do Produto">
                        </div>
                        <div class="form-group col-md-2">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="promocaovalor" value="{{ $produto ->promocaovalor }}" class="form-control" id="promocaovalor" disabled placeholder="Valor do Produto com o desconto">
                        </div>
                    </div>
